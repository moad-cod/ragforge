"""Metric aggregation for Airflow benchmark reports."""
...
from evaluation.airflow_benchmark.models import RunMeasurement
...
def summarize_runs(runs: list[RunMeasurement], *, elapsed_seconds: float) -> dict[str, Any]:
