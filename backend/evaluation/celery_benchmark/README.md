...
This package implements the Celery side of the RAGForge orchestrator evaluation framework.

It drives the current FastAPI file-ingestion endpoint, waits for the Celery-backed ingestion
