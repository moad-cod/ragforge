"""Async FastAPI client used by the Celery benchmark runner."""
...
from evaluation.celery_benchmark.models import utc_now
from evaluation.celery_benchmark.validator import TERMINAL_STATUSES
...
class CeleryBenchmarkClient:
    ...
    async def create_or_login_identity(
        ...
        *,
        ...
        effective_password = password or "ragforge-celery-benchmark"
        if email:
        ...
        generated_email = f"celery-benchmark-{uuid.uuid4().hex[:12]}@example.com"
        await self.register(
            email=generated_email,
            password=effective_password,
            full_name="Celery Benchmark",
        )
